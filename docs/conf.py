...
# -*- coding: utf-8 -*-
#
# django_river_ml documentation build configuration file, created by
...
from django_river_ml import version
...
htmlhelp_basename = "django_river_mldoc"
...
texinfo_documents = [
    (
        "index",
        "django_river_ml",
        "Django River ML Documentation",
        ["Vanessa Sochat"],
        "django_river_ml",
        "Django River ML is a Django plugin for river",
        "Miscellaneous",
    ),
]
